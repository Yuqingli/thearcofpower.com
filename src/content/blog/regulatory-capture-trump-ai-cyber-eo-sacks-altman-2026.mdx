...
<img src="/blog/regulatory-capture-trump-ai-cyber-eo-sacks-altman-2026-hero.jpg" alt="Council on Foreign Relations analysis of Trump's AI executive order — regulatory capture assessment" style={{width: '100%', borderRadius: '16px', marginBottom: '2rem'}} />
...
<a href="https://www.npr.org/2026/06/02/nx-s1-5844347/ai-safety-trump-executive-order" target="_blank" rel="noopener noreferrer"><img src="/blog/whitehouse-eo.png" alt="White House executive order text — Promoting Advanced Artificial Intelligence Innovation and Security" style={{width: '100%', maxWidth: '550px', borderRadius: '12px', border: '1px solid #e0e0e0', marginTop: '1rem', marginBottom: '1rem'}} /></a>
